...
export const SKILL_TREE: SkillSlot[] = [
  ...
  { id: "lightning_dmg_2", spellId: "lightning", category: "spell", group: "lightning_dmg",
    name: "Voltage II",    description: "+1 base damage per level.", cost: flat(5, 5),   requires: "lightning_dmg_1", perLevelLabel: "+1 dmg" },
  { id: "lightning_dmg_3", spellId: "lightning", category: "spell", group: "lightning_dmg",
    name: "Voltage III",   description: "+1 base damage per level.", cost: flat(5, 30),  requires: "lightning_dmg_2", perLevelLabel: "+1 dmg" },
