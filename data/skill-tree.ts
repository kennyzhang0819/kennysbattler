...
export const SKILL_TREE: SkillSlot[] = [
  ...
  },
  {
    ...
    name: "Blaze II", description: "+2 base damage per level.", cost: flat(5, 5), requires: "fireball_dmg_1", perLevelLabel: "+2 dmg"
  },
  {
    id: "fireball_dmg_3", spellId: "fireball", category: "spell", group: "fireball_dmg",
    name: "Blaze III", description: "+2 base damage per level.", cost: flat(5, 20), requires: "fireball_dmg_2", perLevelLabel: "+2 dmg"
  },
  {
    id: "fireball_dmg_4", spellId: "fireball", category: "spell", group: "fireball_dmg",
    name: "Blaze Final", description: "+2 base damage per level.", cost: flat(100, 50), requires: "fireball_dmg_3", perLevelLabel: "+2 dmg"
  },
  ...
  },
  {
    ...
    name: "Vitality II", description: "+2 base max HP bonus per level.", cost: flat(5, 5), requires: "restore_heal_1", perLevelLabel: "+2 HP"
  },
  {
    id: "restore_heal_3", spellId: "restore", category: "spell", group: "restore_heal",
    name: "Vitality III", description: "+2 base max HP bonus per level.", cost: flat(5, 20), requires: "restore_heal_2", perLevelLabel: "+2 HP"
  },
  {
    id: "restore_heal_4", spellId: "restore", category: "spell", group: "restore_heal",
    name: "Vitality IV", description: "+2 base max HP bonus per level.", cost: flat(5, 50), requires: "restore_heal_3", perLevelLabel: "+2 HP"
  },
  ...
  },
  {
    ...
    name: "Rejuvenation Final", description: "+1% of max HP healed per level.", cost: flat(100, 50), requires: "restore_pct_3", perLevelLabel: "+1%"
  },
  ...
  },
  {
    ...
    name: "Voltage II", description: "+1 base damage per level.", cost: flat(6, 5), requires: "lightning_dmg_1", perLevelLabel: "+1 dmg"
  },
  {
    id: "lightning_dmg_3", spellId: "lightning", category: "spell", group: "lightning_dmg",
    name: "Voltage III", description: "+1 base damage per level.", cost: flat(5, 20), requires: "lightning_dmg_2", perLevelLabel: "+1 dmg"
  },
  {
    id: "lightning_dmg_4", spellId: "lightning", category: "spell", group: "lightning_dmg",
    name: "Voltage Final", description: "+1 base damage per level.", cost: flat(100, 50), requires: "lightning_dmg_3", perLevelLabel: "+1 dmg"
  },
  ...
  },
  {
    ...
    name: "Income III", description: "+1 gold per turn.", cost: [300], requires: "shop_gold_2", perLevelLabel: "+1 gold"
  },
